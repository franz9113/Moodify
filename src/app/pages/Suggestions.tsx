...
const MOOD_TOOLS: Record<string, string> = {
...
export default function Suggestions() {
  ...
  const recommendedTool = MOOD_TOOLS[entry.mood] || 'Mindfulness Meditation';
    ...
    >
      ...
      <div className='flex-1 px-5 space-y-6 pb-40'>
        ...
        <div className='bg-white rounded-[32px] p-6 shadow-sm border-b-4 border-black/5'>
          ...
          <p
            ...
            style={{ color: THEME.colors.text }}
          >
            Your positive energy is wonderful. Consider sharing your joy with
            someone or documenting what made you happy today.
          </p>
        ...
        <div className='bg-white rounded-[32px] p-8 shadow-sm border-b-4 border-black/5'>
          <h2
            className='font-black text-sm uppercase tracking-tight mb-6'
            style={{ color: THEME.colors.text }}
          >
            Your Entry Summary
          </h2>
      ...
      >
        <button
          ...
          className={`w-full py-4 rounded-[24px] font-black text-lg shadow-lg ${THEME.interactive.activeScale}`}
          style={{
            backgroundColor: THEME.colors.primary,
            color: THEME.colors.text,
            transition: THEME.interactive.transition,
          }}
        >
          Back to Home
        </button>
