...
import { ChevronRight, Heart, Brain, Wind, Activity, BookOpen, X } from "lucide-react";
    ...
    return (
      <div className="flex flex-col h-full pb-20">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <div className={`${selectedTool.color} rounded-2xl p-6 mb-6 flex items-center justify-center`}>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-900">
              <strong>Tip:</strong> Practice this technique regularly for the best results. Consistency is key to developing healthy emotional regulation habits.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        ...
        <div className="mt-8 p-4 bg-gradient-to-br from-cyan-50 to-teal-50 rounded-xl">
          ...
          <p className="text-sm text-gray-600">
            If you're experiencing persistent or severe emotional distress, please consider reaching out to a mental health professional. These tools are meant to supplement, not replace, professional care.
          </p>
        </div>
      </div>
    </div>
