...
export default function Questions() {
    ...
    return (
      <div className="h-full flex flex-col bg-white">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <p className="text-gray-600 mb-6">Tap on the body parts where you felt the emotion</p>
            ...
            <svg viewBox="0 0 200 400" className="w-full">
              ...
              <ellipse
                ...
                className={`cursor-pointer transition-all ${
                  selectedBodyParts.includes("head") ? "fill-cyan-300" : "fill-gray-200"
                } hover:fill-cyan-200`}
              ...
              <rect
                ...
                rx="10"
                className={`cursor-pointer transition-all ${
                  selectedBodyParts.includes("chest") ? "fill-cyan-300" : "fill-gray-200"
                } hover:fill-cyan-200`}
              ...
              <rect
                ...
                rx="10"
                className={`cursor-pointer transition-all ${
                  selectedBodyParts.includes("stomach") ? "fill-cyan-300" : "fill-gray-200"
                } hover:fill-cyan-200`}
              ...
              <rect
                ...
                rx="15"
                className={`cursor-pointer transition-all ${
                  selectedBodyParts.includes("left-arm") ? "fill-cyan-300" : "fill-gray-200"
                } hover:fill-cyan-200`}
              ...
              <rect
                ...
                rx="15"
                className={`cursor-pointer transition-all ${
                  selectedBodyParts.includes("right-arm") ? "fill-cyan-300" : "fill-gray-200"
                } hover:fill-cyan-200`}
              ...
              <rect
                ...
                rx="12"
                className={`cursor-pointer transition-all ${
                  selectedBodyParts.includes("left-leg") ? "fill-cyan-300" : "fill-gray-200"
                } hover:fill-cyan-200`}
              ...
              <rect
                ...
                rx="12"
                className={`cursor-pointer transition-all ${
                  selectedBodyParts.includes("right-leg") ? "fill-cyan-300" : "fill-gray-200"
                } hover:fill-cyan-200`}
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
        <h1 className="text-xl">Question {currentQuestionIndex + 1} of {questions.length}</h1>
        <button onClick={() => navigate("/")} className="p-2">
          <X size={24} />
        </button>
      </div>
